/*------------ hw1ie2.c -------------------------------------------------------------
      Program: homework 1 ie2
       Author: 강 혁 (KANG HYUK)
   Student ID: 12130919
      User ID: s12130919
       E-mail: k941026h@naver.com
 
     Creation: Nov.  14, 2019
 Modification: Nov.  14, 2019
     Due Date:
-------------------------------------------------------------------------------*/ 
#include <stdio.h>
#include <stdlib.h>
...
struct node *expr(void){
	...
	n = (struct node *)malloc(sizeof(struct node));
	Expr = (struct node *)malloc(sizeof(struct node));	
	Expr = term();
