...
void KnightTourFreq() {
	...
	cout << "Knight가 어떤 칸을 지났는지에 대한 여부를 출력합니다. (지나간 횟수 출력)\n" << endl;
	cout << "tour를 시작할 칸을 입력하세요.\n";
	cout << "행 : ";
	cin >> currentRow;
	cout << "열 : ";
	cin >> currentColumn;
...
void KnightTourRoot() {
	...
	cout << "경로를 탐색합니다. tour를 시작할 칸을 입력하세요.\n" << endl;
	cout << "이 알고리즘으로는 (1, 1) , (2, 3)에서 완성된 tour가 진행됩니다.\n\n";
	cout << "행 : ";
	cin >> currentRow;
	cout << "열 : ";
	cin >> currentColumn;
...
int main() {
	...
	// (1, 1) , (2, 3) 에서 해당 알고리즘을 통해 루트를 구할 수 있다.
